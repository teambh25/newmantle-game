    ...
    def _validate_quiz(self, quiz: schemas.Quiz):
        ...
        if len(quiz.scores) < self.configs.max_rank:
            raise exceptions.InvalidParameter(
                "The length of scores is less than max rank"
            )
